...
### Design
#### Colour Scheme
The site uses a total of 5 colours. 
...
#### Balsamic
* Balsamic desktop was used to create initial wireframes of the site. 
#### Figma
...
#### jQuery:
* jQuery came with Bootstrap to make the navbar responsive but was also used for X.
#### Git
...
#### Using Github Pages
1. Navigate to the GitHub Repository:X
...
1. Fork the Repo.
2. Log in to GitHub and locate the X repository.
...
Should you find a bug and want to help us squash it. Please open an issue (here) with clear detail under the following:
* What you done?
* Where you done it?
* What you expected to happen?
* What actually happened?
	
To request a new feature or function then please open an issue (here) with proposed changes including snippets of how to do so.
...
### Media
The hero image was taken from . . .
Various other images are taken from, with permission, Prusa Research, Caribou 3D and Grégoire Saunier.
The embedded YouTube content is used with permission from Chris Warkocki.

### Acknowledgements
* My Mentor, Seun for feedback and guidance.
* Prusa Research for allowing me to use their images and content. 
* Caribou 3D for allowing me to use their images and content.
* Grégoire Saunier for allowing me to use images.
* Chris Warcocki for allowing me to embed his content. 